...
public enum ProjectErrorMessages {
    ...
    INVALID_NON_LETTER_ID("Project ID \"%s\" is invalid: starts with non-letter character '%s'. ID should start with a latin letter and contain only latin letters, digits and underscores (at most %d characters)."),
